...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping( "Gummy Worms", 1.25, new ArrayList<>(Arrays.asList("gelatin")));
        Topping topping2 = new Topping( "Chocolate Syrup", 0.50, new ArrayList<>(Arrays.asList("dairy")));
        Topping topping3 = new Topping( "Strawberry Syrup", 0.50, new ArrayList<>(Arrays.asList("red #5")));
        Topping topping4 = new Topping( "Peanut M&M's", 0.75, new ArrayList<>(Arrays.asList("dairy", "nuts", "dyes")));
